// TAP DASH SHOWDOWN — 90s ARCADE FULL EDITION
// Single-file React app (App.jsx) with arcade.css appended below
// Drop this into a Vite or CRA React project as src/App.jsx and create src/arcade.css with the CSS block found at the end of this file.
...
// update leaderboard (single mode only)
if (mode === 'single') {
const score = players.p1.score;
const entry = {
score,
...
animation: `fadeOut ${
players.p1.target.life / 1000
}s linear`,
}}
>
{players.p1.target.isBomb ? '💣' : '🎯'}
</div>
)}
...
animation: `fadeOut ${
players.p2.target.life / 1000
}s linear`,
}}
>
{players.p2.target.isBomb ? '💣' : '🎯'}
</div>
)}
